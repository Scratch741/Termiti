...
class GameViewModel(app: Application) : AndroidViewModel(app) {
    ...
    val allCards = listOf(
        ...
        Card("001", "Základní útok",  "Zaútočí na nepřítele za 5.",              cost = 2, costType = ResourceType.ATTACK, rarity = Rarity.COMMON,
                effects = listOf(CardEffect.AttackPlayer(5)),artResId = R.drawable.art_zakladni_utok, type = "Útok", isBasic = true),
        Card("008", "Šípy",           "Zaútočí na hrad za 3.",              cost = 1, costType = ResourceType.ATTACK, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.AttackCastle(3)), artResId = R.drawable.art_sipy, type = "Útok", soundResId = R.raw.arrow_hit),
        ...
        Card("007", "Silný úder",       "Zaútočí na nepřítele za 11.",             cost = 4, costType = ResourceType.ATTACK, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AttackPlayer(11)), type = "Útok",artResId = R.drawable.art_silny_uder, artScale = 0.80f, artBiasY = -1.00f, isBasic = true),
        ...
        Card("002", "Kamenná zeď",    "Postaví hradby +9.",                      cost = 3, costType = ResourceType.STONES, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.BuildWall(9)),artResId = R.drawable.art_kamenna_zed, type = "Stavba", artScale = 0.80f, artBiasX = -0.50f, artBiasY = -1.00f, isBasic = true),
        Card("010", "Palisáda",       "Hradby +5, vrátí 1 kámen.",               cost = 2, costType = ResourceType.STONES, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.BuildWall(5), CardEffect.AddResource(ResourceType.STONES, 1)), artResId = R.drawable.art_palisada, type = "Stavba", artScale = 0.80f, artBiasY = -1.00f, isBasic = true),
        Card("005", "Posila hradu",   "Opraví hrad o 4.",                        cost = 2, costType = ResourceType.STONES, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.BuildCastle(4)),artResId = R.drawable.art_posila_hradu, type = "Stavba", artScale = 0.80f, artBiasY = -0.30f, isBasic = true),
        Card("009", "Pevné základy",  "Opraví hrad o 8.",                        cost = 4, costType = ResourceType.STONES, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.BuildCastle(8)), type = "Stavba", artResId = R.drawable.art_pevne_zaklady, artScale = 0.80f, artBiasY = 0.50f, isBasic = true),
        ...
        Card("004", "Magie",          "Okamžitě +2 magie. [Combo]",              cost = 0, costType = ResourceType.MAGIC, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.AddResource(ResourceType.MAGIC, 2)), isCombo = true, artResId = R.drawable.art_magie, type = "Magie", artBiasY = -1.00f, isBasic = true),
        Card("011", "Zásoby kamene",  "Okamžitě +4 kameny. [Combo]",             cost = 1, costType = ResourceType.MAGIC, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.AddResource(ResourceType.STONES, 4)), isCombo = true, artResId = R.drawable.art_zasoby_kamene, type = "Magie", artScale = 0.80f, artBiasY = -0.55f, isBasic = true),
        Card("012", "Mobilizace",     "Okamžitě +3 útoku. [Combo]",              cost = 1, costType = ResourceType.MAGIC, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.AddResource(ResourceType.ATTACK, 3)), isCombo = true,artResId = R.drawable.art_mobilizace, type = "Magie", artScale = 0.80f, artBiasY = -0.30f, isBasic = true),

        // ── Doly (platí MAGIC) ────────────────────────────────────────
        Card("013", "Magický pramen", "Trvale +1 důl magie/kolo.",               cost = 3, costType = ResourceType.MAGIC, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AddMine(ResourceType.MAGIC, 1)), artResId = R.drawable.art_magicky_pramen, type = "Důl", artScale = 0.80f, artBiasY = -0.40f, isBasic = true),
        Card("014", "Kamenolom",      "Trvale +1 důl kamene/kolo.",              cost = 3, costType = ResourceType.MAGIC, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AddMine(ResourceType.STONES, 1)),artResId = R.drawable.art_kamenolom, type = "Důl", artScale = 0.75f, artBiasY = -0.30f, isBasic = true),
        Card("015", "Výcvikový tábor","Trvale +1 důl útoku/kolo.",               cost = 3, costType = ResourceType.MAGIC, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AddMine(ResourceType.ATTACK, 1)),artResId = R.drawable.art_vycvikovy_tabor, type = "Důl", artScale = 0.85f, artBiasY = -0.20f, isBasic = true),
        ...
        Card("019", "Zápalné šípy",   "Poškodí jen hradby o 5.",                 cost = 1, costType = ResourceType.ATTACK, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.AttackWall(5)), artResId = R.drawable.art_zapalne_sipy, type = "Útok", artScale = 0.80f, artBiasY = -1.00f, soundResId = R.raw.arrow_hit),
        Card("020", "Beranidlo",      "Poškodí jen hradby o 12.",                 cost = 3, costType = ResourceType.ATTACK, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AttackWall(12)), artResId = R.drawable.art_beranidlo, type = "Útok", artScale = 0.85f, artBiasY = 0.05f),
        ...
        Card("023", "Dvojitý úder",   "Zaútočí na hrad za 7 a hradby za 7.",     cost = 5, costType = ResourceType.ATTACK, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.AttackCastle(7), CardEffect.AttackWall(7)),artResId = R.drawable.art_dvojity_utok, type = "Útok", artScale = 0.80f, artBiasY = -1.00f),
        ...
        Card("027", "Válečné bubny",  "Zaútočí za 4 a přidá +2 útoku. [Combo]", cost = 2, costType = ResourceType.ATTACK, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.AttackPlayer(4), CardEffect.AddResource(ResourceType.ATTACK, 2)), isCombo = true, artResId = R.drawable.art_valecne_bubny, type = "Útok", artScale = 0.80f, artBiasY = -0.60f, soundResId = R.raw.drums_of_war),
        ...
        Card("030", "Kamenný val",    "Postaví hradby +13.",                     cost = 4, costType = ResourceType.STONES, rarity = Rarity.RARE,
            effects = listOf(CardEffect.BuildWall(13)), type = "Stavba", artResId = R.drawable.art_kamenny_val, artScale = 0.80f, artBiasY = -1.00f),
        Card("031", "Renovace",       "Opraví hrad o 6.",                        cost = 3, costType = ResourceType.STONES, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.BuildCastle(6)),artResId = R.drawable.art_renovace, type = "Stavba", artScale = 0.85f, artBiasY = -1.00f, isBasic = true),
        Card("032", "Citadela",       "Opraví hrad o 13.",                       cost = 6, costType = ResourceType.STONES, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.BuildCastle(13)), type = "Stavba", artResId = R.drawable.art_citadela, artScale = 0.80f, artBiasY = -0.80f),
        Card("033", "Zemní val",      "Pokud máš <8 hradeb, postav +11.",        cost = 2, costType = ResourceType.STONES, rarity = Rarity.RARE,
            effects = listOf(CardEffect.ConditionalEffect(
                Condition.WallBelow(8),
                CardEffect.BuildWall(11)
        ...
        Card("035", "Základní kámen", "Hradby +5 a hrad +4.",                    cost = 3, costType = ResourceType.STONES, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.BuildWall(5), CardEffect.BuildCastle(4)),artResId = R.drawable.art_zakladni_kamen, type = "Stavba", artScale = 0.80f, artBiasY = 0.25f),
        ...
        Card("038", "Vojenský rozkaz","Okamžitě +6 útoku. [Combo]",             cost = 3, costType = ResourceType.MAGIC, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AddResource(ResourceType.ATTACK, 6)), isCombo = true,artResId = R.drawable.art_vojensky_rozkaz, type = "Magie", artScale = 0.80f, isBasic = true),
        Card("039", "Stavební boom",  "Okamžitě +6 kamene. [Combo]",            cost = 3, costType = ResourceType.MAGIC, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AddResource(ResourceType.STONES, 6)), isCombo = true,artResId = R.drawable.art_stavebni_boom, type = "Stavba", artScale = 0.80f, artBiasY = 0.25f, isBasic = true),
        ...
        Card("044", "Trifekta dolů",  "+1 důl magie, útoku i kamene/kolo.",      cost = 6, costType = ResourceType.MAGIC, rarity = Rarity.LEGENDARY,
            ...
            ), type = "Důl",artResId = R.drawable.art_trifekta_dolu, artScale = 0.80f, artBiasY = -0.35f),
        Card("045", "Očarované doly",      "Trvale +3 doly magie/kolo.",              cost = 7, costType = ResourceType.MAGIC, rarity = Rarity.LEGENDARY,
            effects = listOf(CardEffect.AddMine(ResourceType.MAGIC, 3)), type = "Důl",artResId = R.drawable.art_ocarovane_doly, artScale = 0.80f),
        ...
        Card("047", "Ogr",            "Zaútočí na nepřítele za 9.",              cost = 3, costType = ResourceType.ATTACK, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AttackPlayer(9)), artResId = R.drawable.art_ogr, type = "Útok", artScale = 0.80f, soundResId = R.raw.ogr, isBasic = true),
        ...
        Card("049", "Jed",            "Zaútočí za 3, soupeř ztratí 3 magie, +1 chaosu.", cost = 3, costType = ResourceType.ATTACK, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AttackPlayer(3), CardEffect.DrainResource(ResourceType.MAGIC, 3),
                CardEffect.AddResource(ResourceType.CHAOS, 1)), artResId = R.drawable.art_jed, type = "Útok", artScale = 0.80f, artBiasY = -0.50f, soundResId = R.raw.jed),
        Card("050", "Podkopání hradeb",        "Zaútočí za 8, soupeř ztratí 4 kameny.",   cost = 4, costType = ResourceType.ATTACK, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AttackPlayer(8), CardEffect.DrainResource(ResourceType.STONES, 4)), type = "Útok", artResId = R.drawable.art_podkopani_hradeb, artScale = 0.80f, artBiasY = 0.35f),
        Card("051", "Drak",           "Zaútočí za 14, hrad −8 přímo, +2 chaosu.", cost = 11, costType = ResourceType.ATTACK, rarity = Rarity.LEGENDARY,
            effects = listOf(CardEffect.AttackPlayer(14), CardEffect.AttackCastle(8),
                CardEffect.AddResource(ResourceType.CHAOS, 2)),artResId = R.drawable.art_drak, type = "Útok", artScale = 0.80f, artBiasY = -1.00f, soundResId = R.raw.dragon_breath),
        Card("052", "Démon",          "Přímý zásah: hrad −16. +2 chaosu.", cost = 14, costType = ResourceType.ATTACK, rarity = Rarity.LEGENDARY,
            effects = listOf(CardEffect.AttackCastle(16),
                CardEffect.AddResource(ResourceType.CHAOS, 2)), artResId = R.drawable.art_demon, type = "Útok", artScale = 0.80f, artBiasY = -0.50f, soundResId = R.raw.demon_laugh),
        ...
        Card("055", "Poslední vzdor",       "Zaútočí za 3, +1 útoku. Pokud <5 hradeb: hrad −8.", cost = 2, costType = ResourceType.ATTACK, rarity = Rarity.EPIC,
            effects = listOf(
                CardEffect.AttackPlayer(3),
                CardEffect.AddResource(ResourceType.ATTACK, 1),
                CardEffect.ConditionalEffect(Condition.WallBelow(5), CardEffect.AttackCastle(8))
            ), type = "Útok",artResId = R.drawable.art_posledni_vzdor, artScale = 0.80f, artBiasY = -1.00f),
        Card("056", "Nájezdník",      "Ukradni 3 útoku, zaútočí za 4.",            cost = 3, costType = ResourceType.ATTACK, rarity = Rarity.RARE,
            effects = listOf(CardEffect.StealResource(ResourceType.ATTACK, 3), CardEffect.AttackPlayer(4)),artResId = R.drawable.art_najezdnik, type = "Útok", artScale = 0.80f, artBiasY = -0.65f, isBasic = true),
        ...
        Card("059", "Pevnostní hrad", "Hradby +5 a hrad +7.",                    cost = 4, costType = ResourceType.STONES, rarity = Rarity.RARE,
            effects = listOf(CardEffect.BuildWall(5), CardEffect.BuildCastle(7)), type = "Stavba", artResId = R.drawable.art_pevnostni_hrad, artScale = 0.80f, artBiasY = -0.50f, isBasic = true),
        ...
        Card("063", "Věž strážní",    "Hradby +11, trvale +1 důl kamene.",       cost = 5, costType = ResourceType.STONES, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.BuildWall(11), CardEffect.AddMine(ResourceType.STONES, 1)),artResId = R.drawable.art_vez_strazni, type = "Stavba", artScale = 0.80f, artBiasY = -1.00f),
        Card("064", "Zásobník",       "Pokud hrad <40, oprav hrad o 10.",        cost = 3, costType = ResourceType.STONES, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.ConditionalEffect(Condition.CastleBelow(40), CardEffect.BuildCastle(10))),artResId = R.drawable.art_zasobnik, type = "Stavba", artScale = 0.80f, artBiasY = -0.50f),

        // ── Sabotáž a krádež (platí MAGIC) ───────────────────────────
        Card("065", "Lupič",          "Ukradni 4 útoku od soupeře.",               cost = 2, costType = ResourceType.MAGIC, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.StealResource(ResourceType.ATTACK, 4)),artResId = R.drawable.art_lupic, type = "Magie", artScale = 0.90f, artBiasY = -0.25f, isBasic = true),
        Card("066", "Kamenná daň",       "Ukradni 4 kameny od soupeře.",              cost = 2, costType = ResourceType.MAGIC, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.StealResource(ResourceType.STONES, 4)), type = "Magie",artResId = R.drawable.art_kamenna_dan, artScale = 0.80f),
        ...
        Card("074", "Tržiště",        "+3 magie, +3 útoku, +3 kameny. [Combo]",  cost = 4, costType = ResourceType.MAGIC, rarity = Rarity.COMMON,
        ...
        Card("075", "Rozmach těžby",     "Trvale +2 magie a +1 kameny/kolo.",       cost = 6, costType = ResourceType.MAGIC, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.AddMine(ResourceType.MAGIC, 2),
                CardEffect.AddMine(ResourceType.STONES, 1)), type = "Důl",artResId = R.drawable.art_rozmach_tezby, artScale = 0.80f, artBiasY = -1.00f),
        Card("076", "Vojenská základna","Trvale +2 útoku a +1 kameny/kolo.",     cost = 6, costType = ResourceType.MAGIC, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.AddMine(ResourceType.ATTACK, 2),
                CardEffect.AddMine(ResourceType.STONES, 1)), type = "Důl",artResId = R.drawable.art_vojenska_zakladna, artScale = 0.80f, artBiasY = -1.00f),
        ...
        Card("078", "Upíří drak",     "Přímý zásah: hrad −10, ukradni 4 magie a 4 útoku, +2 chaosu.", cost = 10, costType = ResourceType.ATTACK, rarity = Rarity.LEGENDARY,
            effects = listOf(CardEffect.AttackCastle(10),
                ...
                CardEffect.AddResource(ResourceType.CHAOS, 2)), artResId = R.drawable.art_draci_upir, type = "Útok", artScale = 0.80f, artBiasY = -1.00f, soundResId = R.raw.dragon_breath),
        ...
        Card("080", "Velkovýroba",    "+2 každý důl.",           cost = 10, costType = ResourceType.MAGIC, rarity = Rarity.LEGENDARY,
            effects = listOf(CardEffect.AddMine(ResourceType.MAGIC, 2),
                CardEffect.AddMine(ResourceType.ATTACK, 2),
                CardEffect.AddMine(ResourceType.STONES, 2),
                ), type = "Důl",artResId = R.drawable.art_velkovyroba, artScale = 0.80f),
        ...
        Card("082", "Masivní zeď", "Postaví hradby +18.", cost = 6, costType = ResourceType.STONES, rarity = Rarity.RARE,
            effects = listOf(CardEffect.BuildWall(18)), type = "Stavba",artResId = R.drawable.art_masivni_zed, artScale = 0.80f, artBiasY = -0.45f),

        Card("083", "Nouzové opevnění", "Pokud máš <10 hradeb, postav +14.", cost = 3, costType = ResourceType.STONES, rarity = Rarity.RARE,
            effects = listOf(CardEffect.ConditionalEffect(
                Condition.WallBelow(10),
                CardEffect.BuildWall(14)
            )),artResId = R.drawable.art_nouzove_opevneni, type = "Stavba", artScale = 0.80f, artBiasY = -0.60f),

        Card("084", "Velká oprava", "Hradby +4 a hrad +7.", cost = 4, costType = ResourceType.STONES, rarity = Rarity.COMMON,
            effects = listOf(
                CardEffect.BuildWall(4),
                CardEffect.BuildCastle(7)
            ), type = "Stavba", artResId = R.drawable.art_velka_oprava, artScale = 0.80f, artBiasY = -0.20f),
        ...
        Card("087", "Pevnost", "Hradby +10 a hrad +8.", cost = 6, costType = ResourceType.STONES, rarity = Rarity.EPIC,
            effects = listOf(
                ...
                CardEffect.BuildCastle(8)
            ), type = "Stavba", artResId = R.drawable.art_pevnost, artScale = 0.80f, artBiasY = -1.00f),
        ...
        Card("088", "Zesílené hradby", "Hradby +10. Pokud máš >30 hradu, +6 navíc.", cost = 4, costType = ResourceType.STONES, rarity = Rarity.RARE,
            ...
            ), type = "Stavba", artResId = R.drawable.art_zesilene_hradby, artScale = 0.80f, artBiasY = -1.00f),

        Card("089", "Architekt", "Hradby +5, trvale +1 důl kamene/kolo.", cost = 4, costType = ResourceType.STONES, rarity = Rarity.RARE,
            effects = listOf(
                CardEffect.BuildWall(5),
                CardEffect.AddMine(ResourceType.STONES, 1)
            ), type = "Důl", artResId = R.drawable.art_architekt, artScale = 0.80f, artBiasY = -0.60f),

        Card("090", "Rozšíření těžby", "Trvale +2 doly kamene/kolo.", cost = 7, costType = ResourceType.STONES, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.AddMine(ResourceType.STONES, 2)), type = "Důl", artResId = R.drawable.art_rozsireni_tezby, artScale = 0.80f, artBiasY = -0.25f),
        ...
        Card("092", "Strategická výstavba", "Pokud máš >20 hradeb, postav +14.", cost = 4, costType = ResourceType.STONES, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.ConditionalEffect(
                Condition.WallAbove(20),
                CardEffect.BuildWall(14)
            )), type = "Stavba", artResId = R.drawable.art_strategicka_vystavba, artScale = 0.80f, artBiasY = -0.55f),
        ...
        Card("095", "Obchod s kamenem", "Získej +5 kamenů.", cost = 2, costType = ResourceType.STONES, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.AddResource(ResourceType.STONES, 5)),artResId = R.drawable.art_obchod_s_kamenem, type = "Stavba", artScale = 0.80f),

        Card("096", "Nedobytná pevnost", "Hradby +18, Hrad +8.", cost = 10, costType = ResourceType.STONES, rarity = Rarity.LEGENDARY,
            effects = listOf(
                CardEffect.BuildWall(18),
                CardEffect.BuildCastle(8)
            ),artResId = R.drawable.art_nedobytna_pevnost, type = "Stavba", artScale = 0.80f),

        Card("097", "Obnova království", "Hrad +25.", cost = 14, costType = ResourceType.STONES, rarity = Rarity.LEGENDARY,
        ...
        Card("C07", "Chaotický štít",    "Hradby +16.",                           cost = 4, costType = ResourceType.CHAOS,  rarity = Rarity.EPIC,
            effects = listOf(CardEffect.BuildWall(16)), type = "Stavba",artResId = R.drawable.art_chaoticky_stit, artScale = 0.80f, artBiasY = -0.20f),
        Card("C08", "Zázrak chaosu",     "Hrad +15.",                             cost = 5, costType = ResourceType.CHAOS,  rarity = Rarity.LEGENDARY,
            effects = listOf(CardEffect.BuildCastle(15)), type = "Stavba",artResId = R.drawable.art_zazrak_chaosu, artScale = 0.80f, artBiasY = -0.20f),
        Card("C09", "Chaotická krize",   "Soupeř ztratí 6 od každého zdroje.",   cost = 7, costType = ResourceType.CHAOS,  rarity = Rarity.LEGENDARY,
        ...
        Card("C10", "Chaotický drak",    "Zaútočí za 15, hrad −12 přímo.",        cost = 11, costType = ResourceType.CHAOS, rarity = Rarity.LEGENDARY,
            effects = listOf(CardEffect.AttackPlayer(15), CardEffect.AttackCastle(12)),artResId = R.drawable.art_chaoticky_drak, type = "Útok", artScale = 0.80f, artBiasY = -1.00f, soundResId = R.raw.dragon_breath),
        Card("C11", "Chaos a řád",       "Hrad +8 a hradby +8.",                  cost = 4, costType = ResourceType.CHAOS,  rarity = Rarity.EPIC,
            effects = listOf(CardEffect.BuildCastle(8), CardEffect.BuildWall(8)), type = "Stavba",artResId = R.drawable.art_chaos_a_rad, artScale = 0.80f, artBiasY = -0.35f),
        Card("C12", "Anarchie",          "Ukradni 5 od každého zdroje soupeře.",    cost = 9, costType = ResourceType.CHAOS,  rarity = Rarity.LEGENDARY,
        ...
        Card("C13", "Sabotáž",           "Znič 1 důl magie (min. 1). Zablokuj produkci na 2 kola.", cost = 5, costType = ResourceType.CHAOS, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.DestroyMine(ResourceType.MAGIC, 1),
                CardEffect.BlockMine(ResourceType.MAGIC, 2)), type = "Chaos",artResId = R.drawable.art_sabotaz, artScale = 0.80f, artBiasY = -0.20f),
        Card("C14", "Ničení kamenolomu", "Znič 1 důl kamene (min. 1). Zablokuj produkci na 2 kola.", cost = 5, costType = ResourceType.CHAOS, rarity = Rarity.EPIC,
            effects = listOf(CardEffect.DestroyMine(ResourceType.STONES, 1),
                CardEffect.BlockMine(ResourceType.STONES, 2)), type = "Chaos",artResId = R.drawable.art_niceni_kamenolomu, artScale = 0.80f, artBiasY = -0.85f),
        ...
        Card("C18", "Krádež osudu",       "Ukradni 2 náhodné karty ze soupeřovy ruky.", cost = 5, costType = ResourceType.CHAOS, rarity = Rarity.LEGENDARY,
            effects = listOf(CardEffect.StealCard(2)), type = "Chaos",artResId = R.drawable.art_kradez_osudu, artScale = 0.80f, artBiasY = -0.75f),
        ...
        Card("C20", "Prázdná mysl",      "Znič 3 náhodné karty ze soupeřovy ruky.", cost = 7, costType = ResourceType.CHAOS, rarity = Rarity.LEGENDARY,
        ...
        Card("C30", "Chrám chaosu",      "Trvale +2 doly chaosu/kolo.",           cost = 7, costType = ResourceType.MAGIC, rarity = Rarity.LEGENDARY,
            effects = listOf(CardEffect.AddMine(ResourceType.CHAOS, 2)), type = "Důl",artResId = R.drawable.art_chram_chaosu, artScale = 0.80f, artBiasY = -0.10f),
        ...
        Card("D01", "Průzkumník",      "Lízni 1 kartu. [Combo]",                     cost = 1, costType = ResourceType.MAGIC,  rarity = Rarity.COMMON,
            effects = listOf(CardEffect.DrawCard(1)), isCombo = true,artResId = R.drawable.art_pruzkumnik, type = "Magie", artScale = 0.80f, artBiasY = 0.30f, isBasic = true),
        ...
        Card("D03", "Kronika",         "Lízni 3 karty.",                              cost = 5, costType = ResourceType.MAGIC,  rarity = Rarity.EPIC,
            effects = listOf(CardEffect.DrawCard(3)), type = "Magie",artResId = R.drawable.art_kronika, artScale = 0.80f, artBiasY = 0.20f),
        Card("D04", "Bojová taktika",  "Zaútočí za 4. Lízni 1 kartu.",               cost = 2, costType = ResourceType.ATTACK, rarity = Rarity.COMMON,
            effects = listOf(CardEffect.AttackPlayer(4), CardEffect.DrawCard(1)),artResId = R.drawable.art_bojova_taktika, type = "Útok", artScale = 0.80f, isBasic = true),
        ...
        Card("099", "Temný přenos","Ukradni 10 životů hradu soupeři.",          cost = 8, costType = ResourceType.MAGIC,  rarity = Rarity.EPIC,
            effects = listOf(CardEffect.StealCastle(10)), type = "Magie",artResId = R.drawable.art_temny_prenos, artScale = 0.80f, artBiasY = -1.00f),
        // Obléhací sání: útočný variant krádeže hradu – kombinuje přímý útok se sáním životů.
        Card("100", "Krvavý úder",    "Zaútočí za 5, ukradni 6 životů hradu.",     cost = 6, costType = ResourceType.ATTACK, rarity = Rarity.RARE,
            effects = listOf(CardEffect.AttackPlayer(5), CardEffect.StealCastle(6)), type = "Útok", artResId = R.drawable.art_krvavy_uder, artScale = 0.80f, artBiasX = -1.00f),
