    ...
    companion object {
        ...
        private fun buildStrings(code: String, s: JSONObject, fb: AppStrings?): AppStrings {
            ...
            return AppStrings(
                ...
                decisionFromDeck        = str("decisionFromDeck",        "Vyber si kartu ze svého balíčku (zkopírovat)"),
                decisionDrawFromDeck    = str("decisionDrawFromDeck",    "Vyber si kartu ze svého balíčku (přesunout do ruky)"),
