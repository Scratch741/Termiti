...
Přidání PvE módu - taková "roadmapa" či storymode, kde bojuješ proti dalším hradům - AI. Tyto hrady / soupeři budou mít vždy nějakou schopnost navíc - začínaj s víc zdroji, doly, speciální karty, více hradu/hradeb, nebo tě nějak omezují - třeba kartami, zdražují ti zdroje, atd. Po poražení tohoto AI se ti udělá, že jsi ho porazil a dostaneš za něj odměnu ve formě nové karty / herní měny (neopakovatelné) a dále můžeš postupovat na další jiné AI.
