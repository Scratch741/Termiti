...
object CardPresentation {
    val presentations: Map<String, CardPres> = mapOf(
        ...
        "050" to CardPres("Zaútočí za 8, soupeř ztratí 4 kameny.",
            ...
            artScale = 0.80f, artBiasY = 0.35f),
        "051" to CardPres("Zaútočí za 14, poškodí hrad −8, chaos +3.",
            R.drawable.art_drak, "Útok",
            artScale = 0.80f, artBiasY = -1.00f, soundResId = R.raw.dragon_breath),
        "052" to CardPres("Poškodí hrad −16. Chaos +4.",
        ...
        "060" to CardPres("Hrad +18.",
            ...
            artScale = 0.80f, artBiasY = -0.25f, listBiasY = 0.10f),
        ...
        "066" to CardPres("Ukradni 4 kamene od soupeře.",
        ...
        "077" to CardPres("Pokud máš >8 magie, získej +10 útoku.",
            ...
            artScale = 0.80f, artBiasY = -1.00f),
        "078" to CardPres("Poškodí hrad −10, ukradni 4 magie a 4 útoku, chaos +3.",
            R.drawable.art_draci_upir, "Útok",
            artScale = 0.80f, artBiasY = -1.00f, soundResId = R.raw.dragon_breath, listBiasY = -0.60f),
        "079" to CardPres("Zaútočí za 12, soupeř ztratí 3 magie, chaos +2.",
            R.drawable.art_oblehani, "Útok",
            artScale = 0.75f, artBiasY = -0.45f),
        "080" to CardPres("Důl magie, útoku i kamene +2.",
            R.drawable.art_velkovyroba, "Důl",
            artScale = 0.80f),

        // ── Stavba – nové posily (STONES buff) ───────────────────────────────
        "131" to CardPres("Zaútočí za 8. Zničí 1 kamenný důl soupeře (min. 1).",
        ...
        "130" to CardPres("Útok +2, kameny −2.\n[Combo]",
            ...
            artScale = 0.80f, artBiasY = 0.10f),
        "129" to CardPres("Hradba +2 a hrad +2. Zlevní náhodnou **STAVBA** kartu v ruce o 2.",
        ...
        "093" to CardPres("Hrad +5. **Toto kolo:** za každou zahranou **STAVBU** +3 hrad. [Combo]",
            ...
            artScale = 0.90f, artBiasY = -1.00f),
        "094" to CardPres("Hradby +6, kámen +2.\n[Combo]",
        ...
        "132" to CardPres("Zaútočí za 5. | **Zahození:** +3 útoku.",
            R.drawable.art_zoufaly_zold, "Útok",
            artScale = 0.80f, isBasic = true),

        // ── Mechanika "Zahození" (ostrá karta) ──────────────────────────────────
        ...
        "134" to CardPres("Bez efektu. | **Zahození:** −4 hrad i hradby.",
            ...
            artScale = 0.80f),
        "135" to CardPres("Ukradni 3 chaosu od soupeře. | **Zahození:** +2 chaosu.",
            R.drawable.art_osudova_mince, "Chaos",
            artScale = 0.80f),
        "136" to CardPres("Zaútočí za 10. | **Zahození:** −4 hradby.",
            R.drawable.art_posledni_vypad, "Útok",
            artScale = 0.80f),
        "137" to CardPres("Magie +2. | **Zahození:** lízni 1 kartu.",
            R.drawable.art_zapomenuta_poznamka, "Magie",
            artScale = 0.80f),
        "138" to CardPres("Hradby +7, soupeř ztratí 3 kameny. | **Zahození:** −5 hradeb.",
            R.drawable.art_podkopane_valy, "Stavba",
            artScale = 0.80f),
        "139" to CardPres("Převede všechny hradby na hrad. | **Zahození:** −8 hradu.",
        ...
        "108" to CardPres("**Rozhodnutí:** Nahlédni do soupeřova balíku a zahoď 1 kartu.",
            ...
            artScale = 0.80f, artBiasY = -1.00f),
        "109" to CardPres("**Rozhodnutí:** Vyber si 1 kartu **ÚTOK** ze hry. Zlevni ji o 2. [Combo]",
            R.drawable.art_rekrut, "Útok",
            artScale = 0.80f, artBiasY = -1.00f),
        "112" to CardPres("**Rozhodnutí:** Vyber si 1 kartu **STAVBA** ze hry. Zlevni ji o 2. [Combo]",
        ...
        "C03" to CardPres("Důl chaosu +1.",
            ...
            artScale = 0.80f),
        "C04" to CardPres("Ukradni 3 chaosu od soupeře.\n[Combo]",
        ...
        "C09" to CardPres("Soupeř ztratí 6 od každého zdroje.",
            ...
            artScale = 0.80f),
        "C10" to CardPres("Zaútočí za 15, poškodí hrad −12.",
            R.drawable.art_chaoticky_drak, "Chaos",
            artScale = 0.80f, artBiasY = -1.00f, soundResId = R.raw.dragon_breath, listBiasY = -0.40f),
        ...
        "C21" to CardPres("Přidej 3 kopie 'Déšť šípů' do svého balíčku.",
        ...
        "C44" to CardPres("Poškodí hrad −7.\nPokud máš více chaosu než soupeř, ukradni 4 hradu.",
            R.drawable.art_dan_z_chaosu, "Chaos",
            artScale = 0.80f, artBiasY = -0.50f,
            descriptionEn = "Castle damage −7.\nIf you have more Chaos than your opponent, steal 4 castle HP.", listBiasY = 0.25f),
        "C45" to CardPres("Ukradni 3 hradu.\n[Combo]",
            R.drawable.art_chaoticka_sipka, "Chaos",
            artScale = 0.80f, artBiasY = -0.50f,
            descriptionEn = "Steal 3 castle HP.\n[Combo]", listBiasY = 0.40f),
        ...
        "C30" to CardPres("Doly chaosu +2.",
            ...
            artScale = 0.80f, artBiasY = -0.10f, listBiasY = 0.10f),
        "C31" to CardPres("Chaos +4, soupeř ztratí 2 od každého zdroje.",
        ...
        "113" to CardPres("**Rozhodnutí:** Vyber si 1 kartu **MAGIE** ze hry. Zlevni ji o 2. [Combo]",
            R.drawable.art_goblin_saman, "Magie",
            artScale = 0.80f, artBiasY = -1.00f),
        "114" to CardPres("**Rozhodnutí:** Vyber si 1 kartu **CHAOS** ze hry. Zlevni ji o 2. [Combo]",
        ...
        "123" to CardPres(
            "Zaútočí za 2 + 4 za každou kartu **ÚTOK** zahranou v tomto tahu.",
        ...
        "124" to CardPres(
            "**Rozhodnutí:** získej 4 magie, 4 útok, 4 kameny, nebo 4 chaos. [Combo]",
        ...
        "126" to CardPres(
            "Chaos +2. **Toto kolo:** každá karta **MAGIE** přidá 2 chaos. [Combo]",
        ...
        "128" to CardPres(
            ...
            nameAccusative = "Archmága", listBiasY = -0.35f),
        "C43" to CardPres(
        ...
        "119" to CardPres(
            "Zaútočí za 7. Dostaneš náhodnou kartu **ÚTOK** do ruky. [Combo]",
        ...
        "122" to CardPres(
            "Hrad +7. Dostaneš náhodnou kartu **STAVBA** do ruky. [Combo]",
        ...
        "L01" to CardPres(
            "Ukradni 3 magie, útoku a kamene. Poškodí hrad −18. Ukradni 5 hradu.",
            R.drawable.art_darkmage, "Chaos",
            artScale = 0.80f, artBiasX = 0.10f, artBiasY = -1.0f,
            descriptionEn = "Steal 3 Magic, 3 Attack and 3 Stone. Castle damage −18. Steal 5 castle HP.",
            nameAccusative = "Temného mága", listBiasY = -0.80f),
    )
}
