...
object CardPresentation {
    val presentations: Map<String, CardPres> = mapOf(
        ...
        "050" to CardPres("Zaútočí za 8, soupeř ztratí 4 kameny.",
            ...
            artScale = 0.80f, artBiasY = 0.35f),
        "051" to CardPres("Zaútočí za 14, hrad −8 přímo, chaos +3.",
            R.drawable.art_drak, "Útok",
            artScale = 0.80f, artBiasY = -1.00f, soundResId = R.raw.dragon_breath),
        "052" to CardPres("Přímý zásah: hrad −16. Chaos +4.",
        ...
        "077" to CardPres("Pokud máš >8 magie, získej +10 útoku.",
            ...
            artScale = 0.80f, artBiasY = -1.00f),
        "078" to CardPres("Přímý zásah: hrad −10, ukradni 4 magie a 4 útoku, chaos +3.",
        ...
        "135" to CardPres("Ukradne **3 CHAOSU** soupeři. | **Zahození:** +2 chaosu.",
            ...
            artScale = 0.80f),
        "136" to CardPres("Zaútočí na nepřítele za 10. | **Zahození:** −4 hradby.",
        ...
        "C03" to CardPres("Důl chaosu +1.",
            ...
            artScale = 0.80f),
        "C04" to CardPres("Ukradni 3 chaos od soupeře.\n[Combo]",
        ...
        "L01" to CardPres(
            "Ukradne 3 magie, útoku a kamenů. Hrad -18. Ukradne 5 životů hradu.",
