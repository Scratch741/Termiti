...
object CardPresentation {
    val presentations: Map<String, CardPres> = mapOf(
        ...
        "133" to CardPres("Nasype **3× Zamořená Krysa** do soupeřova balíčku. | **Při zahození:** −5 hradeb.",
            R.drawable.art_placeholder_chaos, "Chaos",
            artScale = 0.80f),
        "134" to CardPres("Prašivá karta bez efektu – **okamžitě ukončí tvé kolo**. | **Při zahození:** −4 hradu, −4 hradby.",
            R.drawable.art_placeholder_chaos, "Chaos",
            artScale = 0.80f),
        "135" to CardPres("Ukradne **3 CHAOSU** soupeři. | **Při zahození:** +2 chaosu.",
            R.drawable.art_placeholder_chaos, "Chaos",
            artScale = 0.80f),
        "136" to CardPres("Zaútočí na nepřítele za 7. | **Při zahození:** −4 hradby.",
            R.drawable.art_placeholder_utok, "Útok",
            artScale = 0.80f),
        "137" to CardPres("Magie +2. | **Při zahození:** lízni 1 kartu.",
            R.drawable.art_placeholder_magie, "Magie",
            artScale = 0.80f),
        "138" to CardPres("Hradby +7, sabotuje soupeři 3 kamene. | **Při zahození:** −5 hradeb.",
            R.drawable.art_placeholder_kamen, "Stavba",
            artScale = 0.80f),
        "139" to CardPres("Převede všechny hradby na hrad. | **Při zahození:** −8 hradu.",
            R.drawable.art_placeholder_kamen, "Stavba",
            artScale = 0.80f),
